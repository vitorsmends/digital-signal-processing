...
def apply_highpass_filter(signal, cutoff_freq, sample_rate, filter_order=101):  # Modificado para ter um número ímpar de coeficientes
    nyquist_rate = sample_rate / 2
    normalized_cutoff_freq = cutoff_freq / nyquist_rate
    taps = firwin(filter_order, normalized_cutoff_freq, pass_zero=False, window='hamming')
...
def apply_highpass_filter_to_audio_file(input_file, output_file, cutoff_freq, filter_order=101):  # Modificado para ter um número ímpar de coeficientes
